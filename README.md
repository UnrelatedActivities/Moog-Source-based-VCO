...
Each directory contains slightly different versions of the same circuit, with same functionality:
...
The PCBs were designed thinking on homemade PCBs using 100x100mm single sided boards. 
I suppose it can be easily edited by those with some experience with Kicad for proper PCB manufacture. 
